      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <Link href="/#areas" className="text-foreground/80 hover:text-foreground transition font-medium text-sm">
              Service Areas
            </Link>
        ...
        {menuOpen && (
          <div className="border-t border-border md:hidden">
            <div className="flex flex-col gap-4 p-4">
              <Link href="/#services" onClick={() => setMenuOpen(false)} className="text-foreground hover:text-lime transition font-medium text-sm">Our Services</Link>
              <Link href="/#areas" onClick={() => setMenuOpen(false)} className="text-foreground hover:text-lime transition font-medium text-sm">Service Areas</Link>
              <Link href="/#about" onClick={() => setMenuOpen(false)} className="text-foreground hover:text-lime transition font-medium text-sm">About</Link>
              <Link href="/#contact" onClick={() => setMenuOpen(false)} className="text-foreground hover:text-lime transition font-medium text-sm">Contact</Link>
